...
> `belief_baselines_status.sh` prints it. They live under `rollout_strategies_**baselines**/`; entries 43/44's
...
`scripts/build_sixteen_probe_report_page.py` from a `PROBES` and a `FIGURES` registry rather than hand-written,
