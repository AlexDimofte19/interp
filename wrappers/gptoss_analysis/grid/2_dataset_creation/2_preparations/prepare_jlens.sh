#!/usr/bin/env bash
# gpt-oss P2 GRID, dataset creation step 2a: the grid_tile PREPARE stage for the JLENS arm -- train and val.
#
# The gpt-oss grid twin of wrappers/qwen_analysis/grid/2_dataset_creation/2_preparations/prepare_jlens.sh.
...
# trajectory the Jacobian lens scored most GRID-loaded at layer 14 (the grid profile's argmax), from the grid gathers in
# ../1_p2_selection.
#
