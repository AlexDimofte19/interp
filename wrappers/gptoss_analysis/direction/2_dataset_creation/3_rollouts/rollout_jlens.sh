#!/usr/bin/env bash
# gpt-oss P2, dataset creation step 3a: ROLLOUT + RELABEL for the JLENS arm -- train and val.
#
# The gpt-oss twin of wrappers/qwen_analysis/2_dataset_creation/3_rollouts/rollout_jlens.sh.
...
ARM=jlens
LENS=jlens          # the ruler that chose this arm's tokens
