...
# same trajectories, same layer, same rollout, same relabel. ARM below names which set of
# picks in {stem}_jlens_selection.json is read -- here, the tokens the Jacobian lens scored
# loudest at layer 27.
set -euo pipefail
