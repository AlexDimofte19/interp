#!/usr/bin/env bash
# Qwen P2 GRID, dataset creation step 2a: the grid_tile PREPARE stage for the JLENS arm -- train and val.
#
# The grid twin of ../../../2_dataset_creation/2_preparations/prepare_jlens.sh. The label is
...
# {stem}_jlens_selection.json are read. Here: the tokens the Jacobian lens scored most
