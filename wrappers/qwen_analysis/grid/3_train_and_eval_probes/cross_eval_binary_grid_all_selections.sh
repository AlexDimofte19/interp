#!/usr/bin/env bash
# Qwen P2 GRID, step 6: the cross-selection matrix. Every binary grid probe is scored on
# every arm's val slice: 3 slices x 3 probe arms x 4 classes x {lr, mlp} = 72 cells.
#
# The grid twin of ../../3_train_and_eval_probes/cross_eval_local_belief_all_selections.sh.
...
PREP=/workspace/prepared/qwen_p2_grid       # reads ${PREP}_${slice}_val
OUT=/workspace/results/qwen_p2_grid/cross_selection_eval
