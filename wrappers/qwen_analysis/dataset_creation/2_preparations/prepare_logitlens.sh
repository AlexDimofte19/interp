#!/usr/bin/env bash
# Qwen P2, dataset creation step 2b: the PREPARE stage for the LOGITLENS arm -- train and val.
#
# Stage 1 of three. This one builds token-major manifests labelled with the trajectory's
# final agent_action; ../3_rollouts/rollout_logitlens.sh measures the local belief at those same
...
# {stem}_jlens_selection.json is read -- here, the tokens the LOGIT lens scored loudest
# at layer 27.
#
