...
# tokens. The top-20 is therefore the loudest 20 of the sample, not of the chain, and the
...
#
# STILL BLOCKED ON THE FIT and on the vocabulary upload, exactly as step 1 is.
set -euo pipefail
...
LAYER=39               # the layer selected and saved at; take it from the step-2 notebook
