...
| `cross_selection_belief_eval.sh` | `rollouts/eval_local_belief.py` | the cross-selection matrix (entry 58): 7 eval slices x the belief probes of matching cadence, 50 cells |
